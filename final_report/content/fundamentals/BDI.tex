...
The option generator commits a list of desires into the desire set.
...
The intention set stores the agent's current focus, which is accompanied by a concrete plan.
...
There are three commitment strategies proposed by Rao and Georgeff~\cite{rao_modeling_1991}: \emph{blind}, \emph{single minded} and \emph{open minded}.
\begin{enumerate}
  \item A blindly committed agent is an agent who maintains his intentions until he believes that he has achieved them.
  \item A single minded committed agent is an agent who maintains his intentions as long as he believes that they are still options.
  \item An open minded committed agent is an agent who maintains his intentions as long as they are still goals. %TODO all these sentences quote ~\cite{Roberto_BDIATL_2005} without being marked as such.
\end{enumerate}
