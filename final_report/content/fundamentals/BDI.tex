...
For example, PRS and dMARS are both BDI-based systems for the reaction control system of the NASA Space Shuttle Discovery\todo{\textbf{@yuansun1990}: If you introduce some external technology, language, algorithm whatevs, you would normally always refer to it; giving a citation to the paper that introduced it. Or, if there is no such paper, at least link to the project homepage in a footnote. This goes for PRS, dMARS as well as for OASIS}.
