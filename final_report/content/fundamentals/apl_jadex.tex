...
Additionally they are capable of controlling their life cycle and they can dynamically discover other agents and communicate with them: exchange asynchronous messages via an \emph{agent communication language} (short: ACL).
The architecture of Jadex looks like the following: ``Viewed from the outside, an agent is a black box, which receives and sends messages.`` \cite{pokahr_jadex_2005} (see figure 2)
\begin{figure}
	\centering
