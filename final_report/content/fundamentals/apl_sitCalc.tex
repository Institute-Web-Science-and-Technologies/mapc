\subsubsection[Situation Calculus.]{Situation Calculus.$^\circ$}\label{fun:apl_sitCalc}
...
Fluents are distinguished in \emph{relational fluents} and \emph{functional fluents}~\cite{levesque_golog:_1997}. %3
