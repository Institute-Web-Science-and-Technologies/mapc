\subsection[Michael Ruster]{Michael Ruster$^{\circ}$}\label{org:0nse}
...
Michael licensed the code after investigating the options given limited by the used external libraries.

In our development phase, Michael was chiefly concerned with map-related tasks.
