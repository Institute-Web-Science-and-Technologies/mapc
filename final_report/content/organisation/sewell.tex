...
Besides the paired programming tasks, MS wrote many of the basic AgentSpeak(L) plans used by agents, such as the parrying, repairing, attacking, and exploring-related actions.
