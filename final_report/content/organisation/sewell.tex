\subsection[Michael Sewell$^{\dagger}$}
...
For a large part of the development time, MS worked together with Artur Daudrich on in a kind of pair programming scenario using online screen sharing software.
...
He is responsible for writing a lot of the JavaDoc documentation for the Java-based part of the agent system and the comments in the AgentSpeak files that explain the code there.
...
Outside of the paired programming tasks, MS wrote many of the basic AgentSpeak plans used by agents, such as the parrying, repairing, attack, and exploring-related actions.
