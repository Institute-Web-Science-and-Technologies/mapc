\subsection[Competition Results]{Competition Results$^{\odot/\circ}$}
The competition took place on two dates (15th and 17th of September) and each team had to play three simulations against all other teams\todo{if you proofread this, make sure to also proofread the next subsection and decide if there is a great overlap and whether we need to merge them.}.
...
\end{figure}
\todo{\textbf{@manuelmittler}: I just wrote ``second match'' as filler in \autoref{dis:achievement_points} and \autoref{dis:ZonesScoresAndAchievementPoints}. Which match was this actually from?}
