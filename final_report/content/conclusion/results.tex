\subsection[Competition Results]{Competition Results$^{\odot/\circ}$}\label{con:competition}
...
Each team had to play three simulations against all other teams\todo{if you proofread this, make sure to also proofread the next subsection and decide if there is a great overlap and whether we need to merge them.}.
...
Figure~\ref{fig:achievement_points} shows the progress of achievement points over time.
...
\begin{figure}[ht]
  ...
  \caption{Achievement points from the third match TUB against MAKo.\todo{As Matthias commented: you can't see a thing on this graphic! Redo it or improve it.}}
...
As it can be seen in Figure~\ref{fig:zonesScoresAndAchievementPoints} the spending of achievement points did not interfere dramatically with the overall score.
...
\begin{figure}[h]
  ...
  \caption{Combined achievement and zone scores from the third match TUB against MAKo.\todo{As Matthias commented: you can't see a thing on this graphic! Redo it or improve it.}}
...
The final results are shown in Figure~\ref{tab:mapc2014results}.
\begin{table}[ht]
  \centering
...
\begin{figure}[h]
  ...
  \caption{One agent alone forming a zone over 25 vertices by occupying an articulation point.\todo{the reference to this is not working.}}
	\label{fig:edgeCases}
\end{figure}
...
Figure~\ref{fig:edgeCases} shows the top left part of the graph from the third match of MAKo against GOAL-DTU.
