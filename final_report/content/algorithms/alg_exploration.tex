...
Finally, this chapter concludes with a description of the second approach we used and finally stuck to in \autoref{alg:map_javamap}. % I'm unsure whether sticking with something is colloquial or at least too informal.
...
After it gets the answer it surveys the vertex or asks the cartographer for the next unsurveyed vertex and travels there\todo{I currently don't know where the word ``unsurveyed'' appears the first. But it is not an actual word but something we invented. Hence, we must shortly mention, what we want to express with it.}.
...
\begin{figure}
  ...
  \label{fig:map:comp3}
\end{figure}
\todo{This section is a bit short and does not have a real ending.}
