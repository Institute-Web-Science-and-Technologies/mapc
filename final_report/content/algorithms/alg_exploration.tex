...
In this list we kept the information which agent was doing which task, e.g.\ we saved in the survey list that an agent reserved a node for surveying.
...
This allowed agents to react to environment changes in every step like already surveyed vertices or enemies in their path to the vertex.
