...
\begin{description}
    \item[Explorer] agents are the only ones who can perform the \texttt{probe} action.
        ...
        Accordingly, an Explorer agent will spend most of its time seeking out, moving towards and finally probing vertices whose value is not yet known.
    ...
    \item[Repairer] agents are the only agents who can perform the \texttt{repair} action for restoring health to disabled agents.
        ...
        It is the \enquote{job} of the disabled agents to find and move towards the closest friendly repairer.
